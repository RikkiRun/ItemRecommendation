...
public class TicketMasterAPI {
	// add a new search function in TicketMaster API, which will actually send HTTP request and get response
	private static final String URL = "https://app.ticketmaster.com/discovery/v2/events.json";
	private static final String DEFAULT_KEYWORD = ""; // no restriction
	private static final String API_KEY ="GI6R3w9PlSStm6YAjPGz7z4RdGYqwMXV";
	...
	//3 parameters are needeed to provide to search method: latitude, longtitude and keyword
	//JSONArray - return value - set to search method
...
//				System.out.println(event);
	...
	/**
	 * Main entry for sample TicketMaste r API requests.
	 */
